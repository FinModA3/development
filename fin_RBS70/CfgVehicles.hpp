...
class CfgVehicles {
	...
	class fin_ITO05M: StaticAAWeapon {
		//AuthNameMaco(fin_ITO05M)
		author = "$STR_FinMod_Author";
		displayName = "ITO05M";
		gunnercansee = "2+4+8+32";
		scope = 2;
		model = "\FinMod\addons\fin_RBS70\RBS70.p3d";		
		mapsize = 2.8;
		class Library { };
	...
	class fin_ITO05M_cluBag : Weapon_Bag_Base {
		author = "$STR_FinMod_Author";
		scope = 2;
		...
		class assembleInfo : assembleInfo {
			displayName = "ITO05M";
			assembleTo = "fin_ITO05M";
			base[] = {
				"fin_ITO05M_standBag"
			};
		};
	};	
	class fin_ITO05M_standBag: Bag_Base {
		author = "$STR_FinMod_Author";
		scope = 2;
		model = "\A3\weapons_f\Ammoboxes\bags\Backpack_Tortila";
		hiddenSelectionsTextures[] = {

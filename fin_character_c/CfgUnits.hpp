...
class fin_Rifleman_RK95 : Fin_Soldier_base_F
{
	...
	linkedItems[]			= { stdItems, fin_m05_vest_wflak_rifleman, fin_m05_Helmet };
	respawnLinkedItems[]	= { stdItems, fin_m05_vest_wflak_rifleman, fin_m05_Helmet };
...
class fin_PL_RK95 : fin_Rifleman_RK95
{
	...
	respawnWeapons[] = { fin_rk95_aimpoint, Throw, Put, Binocular };
	magazines[]				= { stdMagLdr , Smoke3Col, Frags };
	respawnMagazines[]		= { stdMagLdr , Smoke3Col, Frags };
	linkedItems[]			= { stdItems, fin_m05_vest_wflak_ldr, fin_m05_Helmet, NVGoggles_OPFOR };	//NVGoggles_Opfor -> vv2000
	respawnLinkedItems[]	= { stdItems, fin_m05_vest_wflak_ldr, fin_m05_Helmet, NVGoggles_OPFOR };
	editorPreview = "\FinMod\addons\fin_character\data\edenpreviews\fin_PL_RK95.jpg";
};
class fin_PSG_RK95 : fin_Rifleman_RK95
{
	...
	magazines[]				= { stdMagLdr , Smoke3Col, Frags };
	respawnMagazines[]		= { stdMagLdr , Smoke3Col, Frags };
	linkedItems[]			= { stdItems, fin_m05_vest_wflak_ldr, fin_m05_Helmet, fin_lisa, NVGoggles_OPFOR };
	respawnLinkedItems[]	= { stdItems, fin_m05_vest_wflak_ldr, fin_m05_Helmet, fin_lisa, NVGoggles_OPFOR };
	editorPreview = "\FinMod\addons\fin_character\data\edenpreviews\fin_PL_RK95.jpg";
};
class fin_FO_RK95 : fin_PL_RK95
{
	...
	respawnWeapons[] = { fin_rk95_aimpoint, Throw, Put, fin_lisa };
	magazines[]				= { stdMagLdr , Smoke3Col };
	respawnMagazines[]		= { stdMagLdr , Smoke3Col };
	linkedItems[]			= { stdItems, fin_m05_vest_wflak_ldr, fin_m05_Helmet, NVGoggles_OPFOR };
	respawnLinkedItems[]	= { stdItems, fin_m05_vest_wflak_ldr, fin_m05_Helmet, NVGoggles_OPFOR };
	editorPreview = "\FinMod\addons\fin_character\data\edenpreviews\fin_PL_RK95.jpg";
};
class fin_SL_RK95 : fin_Rifleman_RK95
{
	...
	magazines[]				= { stdMagLdr, SmokeShell, stdSmoke};
	respawnMagazines[]		= { stdMagLdr, SmokeShell, stdSmoke};
	linkedItems[]			= { stdItems, fin_m05_vest_wflak_ldr, fin_m05_Helmet, NVGoggles_OPFOR };
	respawnLinkedItems[]	= { stdItems, fin_m05_vest_wflak_ldr, fin_m05_Helmet, NVGoggles_OPFOR };
	editorPreview = "\FinMod\addons\fin_character\data\edenpreviews\fin_PL_RK95.jpg";
};
...
class fin_AA_ITO05M_launchercarrier : fin_Rifleman_RK95
{
	...
	linkedItems[] = { stdItems, fin_m05_vest_wflak_rifleman, fin_m05_Helmet, fin_ITO05M_cluBag };
	respawnLinkedItems[] = { stdItems, fin_m05_vest_wflak_rifleman, fin_m05_Helmet, fin_ITO05M_cluBag };
...
class fin_AA_ITO05M_standcarrier : fin_Rifleman_RK95
{
	...
	weapons[] = { fin_rk95, Throw, Put };
	respawnWeapons[] = { fin_rk95, Throw, Put };
	linkedItems[] = { stdItems, fin_m05_vest_wflak_rifleman, fin_m05_Helmet, fin_ITO05M_standBag };
	respawnLinkedItems[] = { stdItems, fin_m05_vest_wflak_rifleman, fin_m05_Helmet, fin_ITO05M_standBag };
	editorPreview = "\FinMod\addons\fin_character\data\edenpreviews\fin_AA_ITO05M_launchercarrier.jpg";
};
...
class fin_CLS_RK95 : fin_Rifleman_RK95
{
	...
	linkedItems[] = { stdItems, fin_m05_vest_wflak_CLS, fin_m05_Helmet };
	respawnLinkedItems[] = { stdItems, fin_m05_vest_wflak_CLS, fin_m05_Helmet };
...
class fin_MG_PKM : fin_Rifleman_RK95
{
	...
	magazines[]			= { stdMagPKM, stdMagPKM, Frags , stdSmoke};
	respawnMagazines[]	= { stdMagPKM, stdMagPKM, Frags , stdSmoke};
	linkedItems[]			= { stdItems, fin_m05_vest_wflak_pkm, fin_m05_Helmet };
	respawnLinkedItems[]	= { stdItems, fin_m05_vest_wflak_pkm, fin_m05_Helmet };
...
class fin_MGa_RK95 : fin_Rifleman_RK95
{
	...
	weapons[] = { fin_rk95, Throw, Put, Binocular };
	respawnWeapons[] = { fin_rk95, Throw, Put, Binocular };
	linkedItems[] = { stdItems, fin_m05_vest_wflak_rifleman, fin_m05_Helmet, stdMagPKM };
	respawnLinkedItems[] = { stdItems, fin_m05_vest_wflak_rifleman, fin_m05_Helmet, stdMagPKM };
};
...
class fin_Sniper_TRG42 : fin_Rifleman_RK95
{
	...
	linkedItems[] = { stdItems, fin_m05_vest_wflak_rifleman, fin_m05_Helmet, stdMagTrg };
	respawnLinkedItems[] = { stdItems, fin_m05_vest_wflak_rifleman, fin_m05_Helmet, stdMagTrg };
};
/* Jaeger platoon 2005 */
...
class fin_Rifleman_RK62: fin_Rifleman_RK95
{
	...
	linkedItems[]			= { stdItems, fin_m05_vest_rifleman, fin_m05_Helmet };
	respawnLinkedItems[]	= { stdItems, fin_m05_vest_rifleman, fin_m05_Helmet };
...
class fin_PL_RK62 : fin_PL_RK95
{
	...
	weapons[] = { fin_rk62, Throw, Put };
	respawnWeapons[] = { fin_rk62, Throw, Put };
	linkedItems[]			= { stdItems, fin_m05_vest_ldr, fin_m05_Helmet, NVGoggles_OPFOR };
	respawnLinkedItems[]	= { stdItems, fin_m05_vest_ldr, fin_m05_Helmet, NVGoggles_OPFOR };
	editorPreview = "\FinMod\addons\fin_character\data\edenpreviews\fin_PL_rk62.jpg";
};
...
class fin_CLS_RK62 : fin_CLS_RK95
{
	...
	weapons[] = { fin_rk62, Throw, Put };
	respawnWeapons[] = { fin_rk62, Throw, Put };
	linkedItems[]			= { stdItems, fin_m05_vest_CLS, fin_m05_Helmet};
	respawnLinkedItems[]	= { stdItems, fin_m05_vest_CLS, fin_m05_Helmet};
...
class fin_MG_PKM2 : fin_MG_PKM
{
	...
	editorSubcategory = fin_vehclass_jaeger2005;
	AuthNameMacro(fin_MG)
	linkedItems[]			= { stdItems, fin_m05_vest_pkm, fin_m05_Helmet };
	respawnLinkedItems[]	= { stdItems, fin_m05_vest_pkm, fin_m05_Helmet };
};
class fin_MGa_RK62 : fin_MGa_RK95
{
	...
	linkedItems[] = { stdItems, fin_m05_vest_rifleman, fin_m05_Helmet, stdMagPKMR };
	respawnLinkedItems[] = { stdItems, fin_m05_vest_rifleman, fin_m05_Helmet, stdMagPKM };
...
class fin_Recon_Rifleman_RK95 : fin_Rifleman_RK95
{
	...
	AuthNameMacro(fin_Rifleman)
	weapons[] = { fin_rk95_aimpoint, Throw, Put };
	respawnWeapons[] = { fin_rk95_aimpoint, Throw, Put };
...
class fin_SF_Rifleman_RK95 : fin_Rifleman_RK95
{
	...
	weapons[] = { fin_rk95_aimpoint, fin_g17, Throw, Put };
	respawnWeapons[] = { fin_rk95_aimpoint, fin_g17, Throw, Put };
...
class fin_SF_Rifleman_AT_RK95 : fin_SF_Rifleman_RK95
{
	...
	weapons[] = { fin_rk95_aimpoint, fin_g17, fin_66kes88, Throw, Put };
	respawnWeapons[] = { fin_rk95_aimpoint, fin_g17, fin_66kes88, Throw, Put };
};
...
class fin_SF_Grenadier_RK95 : fin_SF_Rifleman_RK95
{
	...
	weapons[] = { fin_rk95_aimpoint, fin_g17, fin_HK96A1, Throw, Put };
	respawnWeapons[] = { fin_rk95_aimpoint, fin_g17, fin_HK96A1, Throw, Put };
...
{
	AuthNameMacro(fin_SF_Rifleman_AT)
	weapons[] = { fin_rk95_aimpoint, fin_g17, fin_66kes_88, Throw, Put };
	respawnWeapons[] = { fin_rk95_aimpoint, fin_66kes_88, fin_g17, Throw, Put };
};
...
class fin_MP_Rifleman : fin_Rifleman_RK95
{
	...
	weapons[] = { fin_rk95_aimpoint, fin_fn_hp, Throw, Put };
	respawnWeapons[] = { fin_rk95_aimpoint, fin_fn_hp, Throw, Put };
};
